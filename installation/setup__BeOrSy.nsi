;NSIS Installer for BeOrSy 3.1.0.15
...
Section ""
  ...
  File ".\..\bin\Release\BeOrSy.exe"
  File ".\..\bin\Release\BeOrSy.exe.config"
  ...
  SetOutPath "$INSTDIR\Resources\ReportTemplates"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Main_Application.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Main_ApplicationList.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Main_Company.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Main_Contact.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Main_ReminderList.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Style.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_Application.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_ApplicationList.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_Contact.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_File.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_Progress.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_Reminder.html"
  File ".\..\bin\Release\Resources\ReportTemplates\Report.Sub_ReminderList.html"

  ;Create Desktop shortcut
  CreateShortCut "$DESKTOP\${AppName}.lnk" "$INSTDIR\BeOrSy.exe" ""

  ;Create "Send To" shortcut
  CreateShortCut "$SENDTO\${AppName} - Datum anhängen.lnk" "$INSTDIR\BeOrSy.exe" ""

  ;Create Starmenue Entry
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ;Create shortcuts
    CreateDirectory "$SMPROGRAMS\$StartMenuFolder"
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\BeOrSy.lnk" "$INSTDIR\BeOrSy.exe"
...
Section "Uninstall"
  ...
  ;Delete SendTo
  CreateShortCut "$SENDTO\${AppName} - Bewerbungsorganisationssystem.lnk" "$INSTDIR\BeOrSy.exe" ""
