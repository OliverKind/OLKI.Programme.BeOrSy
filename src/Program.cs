...
namespace OLKI.Programme.BeOrSy.src
{
    internal static class Program
    {
        ...
        /// <summary>
        /// Manager to manage Postcodes
        /// </summary>
        public static PostcodeManger.PostcodeManager PostcodeManager = new PostcodeManger.PostcodeManager();
        #endregion
        ...
        static void Main(string[] args)
        {
            ...
            PostcodeManager.LoadPostcodesFromSettings();
        ...
        /// <summary>
        /// Converter for Boolen Values to user readable
        /// </summary>
        internal class BoolClassConverter : BooleanConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                return (bool)value ? Stringtable._0x0006 : Stringtable._0x0007;
            }

            public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
            {
                return (string)value == Stringtable._0x0006;
            }
        }
        #endregion
    }
